      ...
      <div>
        <div class='footer__section'>
          ...
          <div class='footer__social-medias'>
            <div class='footer__social-media twitter'>
              <svg class='twitter' viewBox='0 0 21 16'>
            ...
            <div class='footer__social-media facebook'>
              <svg class='facebook' viewBox='0 0 16 16'>
        ...
        <div class='footer__section'>
          ...
          <div>
            <ul class='footer__countries'>
              <li class='footer__item'>日本</li>
              <li class='footer__item'>United States</li>
            </ul>
          </div>
        </div>
      </div>
