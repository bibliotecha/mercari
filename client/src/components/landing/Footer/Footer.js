    ...
    <footer>
      <div>
        ...
        <div className='footer__section'>
          ...
          <div>
            <ul className='footer__items'>
              <li className='footer__item'>メルカリガイド</li>
              <li className='footer__item'>らくらくメルカリ便</li>
              <li className='footer__item'>ゆうゆうメルカリ便</li>
              <li className='footer__item'>梱包・発送たのメル便</li>
              <li className='footer__item'>車体取引ガイド</li>
              <li className='footer__item'>メルカリあんしん・あんぜん宣言！</li>
              <li className='footer__item'>偽ブランド品撲滅への取り組み</li>
              <li className='footer__item'>メルカリボックス</li>
              <li className='footer__item'>スマホ出品・売却相場</li>
            </ul>
          </div>
        </div>
      </div>
      <div>
        <div className='footer__section'>
          ...
          <div>
            <ul className='footer__items'>
              <li className='footer__item'>プライバシーポリシー</li>
              <li className='footer__item'>メルカリ利用規約</li>
              <li className='footer__item'>
                あんしんスマホサポート制度に関する利用特約
              </li>
              <li className='footer__item'>コンプライアンスポリシー</li>
            </ul>
          </div>
        </div>
        <div className='footer__section'>
          ...
          <div>
            <ul className='footer__items'>
              ...
              <li className='footer__item'>特定商取引に関する表記</li>
              <li className='footer__item'>資金決済法に基づく表示</li>
              <li className='footer__item'>法令遵守と犯罪抑止のために</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div className='footer__section'>
          ...
          <div>
            <ul className='footer__countries'>
              <li className='footer__item'>日本</li>
              <li className='footer__item'>United States</li>
            </ul>
          </div>
        </div>
      </div>
